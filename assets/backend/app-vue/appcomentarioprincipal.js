var this_js_script = $("script[src*=appcomentarioprincipal]");
...
var c = new Vue({
    ...
    methods: {
        ...
        todosComentarios() {
            ...
            axios.get(this.url + "Principal/getItem/" + this.idnoticia)
        ...
        imagenesNoticia() {
            axios.get(this.url + "Principal/imagenesNoticia/" + this.idnoticia)
                .then(function (response) {
                    console.log(response);
        ...
        detalleNoticia() {
            axios.get(this.url + "Principal/detalleNoticia/" + this.idnoticia)
                .then(function (response) {
                    console.log(response);
